...
os.system(f"py main.py --mesh {input_path}/1000x1000_quad.msh --data {input_path}/global_data.json")
log_dir_name = os.path.join(output_path, "1000x1000_quad")
os.rename(log_dir_name, f"{log_dir_name}_gpu")
os.system(f"py main.py --mesh {input_path}/1000x1000_quad.msh --data {input_path}/global_data.json --force-cpu")
log_dir_name = os.path.join(output_path, "1000x1000_quad")
os.rename(log_dir_name, f"{log_dir_name}_cpu")
