...
os.system(f"py scripts/log_parser.py --file gpu_stats.csv --log-dir-template *_gpu*")
...
os.system(f"py scripts/log_parser.py --file cpu_stats.csv --log-dir-template *_cpu*")